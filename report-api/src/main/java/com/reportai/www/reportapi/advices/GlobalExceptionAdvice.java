...
public class GlobalExceptionAdvice {
    ...
    public ResponseEntity<HttpErrorResponseDTO> handleDefinedHttpExceptions(HttpAbstractException exception) {
    ...
    public ResponseEntity<HttpMultipleErrorResponseDTO> handleDefinedHttpExceptions(HttpMultiAbstractException exceptions) {
