...
public class ClientService {
    ...
    // TODO: refactor after entity changes
//    @Transactional
//    public StudentClientPersona linkStudentClientToAccount(StudentClientPersona client, UUID accountId) {
//        Account account = accountRepository.findById(accountId).orElseThrow(() -> new ResourceNotFoundException("account is not found"));
//        if (account.getStudentClient() != null) {
