...
public class EducatorAccountCreationStrategy implements AccountCreationStrategy {
    ...
    public EducatorAccountCreationStrategy(UUID institutionId, Account requestedAccount, ClientResource clientResource, RealmResource realmResource, AccountRepository accountRepository, InstitutionRepository institutionRepository) {
